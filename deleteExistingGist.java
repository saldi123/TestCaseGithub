...
public class deleteExistingGist {
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		// click on the gist you would like to delete
		driver.findElement(By.xpath("//strong[@class='css-truncate-target'][contains(text(),'deleteMePlease.java')]")).click();
		...
		// initiate Javascript alert function
